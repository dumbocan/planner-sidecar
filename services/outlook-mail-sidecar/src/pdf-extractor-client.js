// Internal HTTP client for the PDF extractor sidecar. The Outlook sidecar never
// sees raw attachment bytes outside the in-memory Buffer flow; this client is
// the only path that crosses the container boundary into the extractor.
